...
public class VideoItemAdapterTeacher extends ArrayAdapter<VideoItem> {
    private Context context;
    private Handler handler = new Handler();
    private VideoView currentVideoView = null;

    public VideoItemAdapterTeacher(@NonNull Context context, List<VideoItem> videoItems) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if (itemView == null) {
            itemView = LayoutInflater.from(context).inflate(R.layout.video_view_layout_teacher, parent, false);
        }
